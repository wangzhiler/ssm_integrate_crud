            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="input" name="email" class="form-control" id="email_update_input" placeholder="email@123.com">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="email_add_input" class="col-sm-2 control-label">email</label>
                        <div class="col-sm-10">
                            <input type="input" name="email" class="form-control" id="email_add_input" placeholder="email@123.com">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
...
<div class="container">
    ...
    <div class="row">
        ...
        <%--分页条信息--%>
        <div class="col-md-6" id="page_navi_area"></div>
    </div>
</div>
<script type="text/javascript">
    ...
    function build_page_info(result) {
        ...
        $("#page_info_area").append("当前为第"+ result.extend.pageInfo.pageNum+"页,总共"
            +result.extend.pageInfo.pages+"页,总共"
            +result.extend.pageInfo.total+"条记录");
        totalRecord = result.extend.pageInfo.total;
        currentPage = result.extend.pageInfo.pageNum;
        // "当前"+ result.extend.pageInfo.pageNum + "页面,总" +
        //result.extend.pageIndo.pages + "页,总共" + result.extend.pageInfo.total + "条记录"
    }

    //解析显示分页条, 点击分页要能去下一页
    function build_page_nav(result){
        $("#page_navi_area").empty();
        //page_navi_area
        ...
        navEle.appendTo("#page_navi_area");
    }
...
//                alert("用户名可以为2-5位中文或者6-16为英文字母和数字的组合");
                //需要先清空之前的元素
                show_validate_msg("#empName_add_input", "error", "用户名可以为2-5位中文或者3-16为英文字母和数字的组合");
                return false;
            }else{
...
//        alert($(this).parents("tr").find("td:eq(1)").text());
    ...
    //1. 我们是按钮创建之前就绑定了click,所以帮不上
    //1). 可以在创建按钮的时候绑定 2). 绑定点击.live()
    //jquery新版没有live 要用on进行替代
